    ...
    companion object {
        ...
        private fun setupSmallWidget(context: Context, views: RemoteViews) {
            runBlocking {
                ...
                val server = db.serverDao().getWidgetServers().first().firstOrNull()
                ...
                if (server != null) {
                    ...
                    views.setImageViewResource(R.id.widget_server_icon, IconUtils.getIconResource(server.iconName))
